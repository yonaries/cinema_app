...
//
//     final upcomingImdb = upcomingImdbFromJson(jsonString);

import 'dart:convert';

UpcomingImdb upcomingImdbFromJson(String str) =>
    UpcomingImdb.fromJson(json.decode(str));

String upcomingImdbToJson(UpcomingImdb data) => json.encode(data.toJson());
...
class UpcomingImdb {
  ...
  factory UpcomingImdb.fromJson(Map<String, dynamic> json) => UpcomingImdb(
